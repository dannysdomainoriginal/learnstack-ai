...
- Generated file management via `/generated` endpoint
- Responsive, modern UI using Tailwind CSS and gradient-based card design
- Smooth animations for flashcards and dashboard interactions

### Tech Stack:

- Frontend: React, Tailwind CSS, Lucide Icons
- Backend: Node.js, Express
- Data Storage: JSON / file-based generated content
- Utilities: Axios for API calls, React Hot Toast for notifications, Moment.js for date formatting

### Purpose:

Learnstack AI is designed to help learners efficiently turn documents into structured study materials, track their learning progress, and retain knowledge through interactive AI-generated content.

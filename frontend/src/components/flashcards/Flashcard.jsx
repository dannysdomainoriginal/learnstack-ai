...
const Flashcard = ({ flashcard, onToggleStar }) => {
  ...
  // Force transparent -> visible (fade-in effect)
  useEffect(() => {
    setVisible(false);
  ...
  return (
    <div
      className={`relative w-full h-72 transition-opacity duration-400 ${visible ? "opacity-100" : "opacity-0"}`}
    ...
    >
      ...
      >
        ...
        >
          ...
          {/* Answer Content */}
          <div className="flex-1 flex items-center justify-center placeholder-cyan-400 py-6">

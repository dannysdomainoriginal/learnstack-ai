      ...
      <div>
        <div className="flex items-start justify-between gap-3 mb-4">
          ...
          <button
            ...
            className="md:opacity-0 group-hover:opacity-100 w-8 h-8 flex items-center cursor-pointer justify-center text-slate-400 hover:text-red-500 hover:bg-red-50 rounded-lg transition-all duration-200"
          >

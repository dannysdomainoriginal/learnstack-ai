...
const LoginPage = () => {
  ...
  return (
    <div className="flex items-center justify-center min-h-screen bg-linear-to-br from-slate-50 via-white to-slate-50 pt-10 pb-12">
      ...
      <div className="relative w-full max-w-md px-6">
          ...
          <div className="space-y-5">
            ...
            <div className="space-y-2">
              ...
              <div className="relative group">
                <div
                  className={`absolute inset-y-0 pl-4 flex items-center pointer-events-none transition-colors duration-200 ${
                    focusedField === "email"
                      ? "text-emerald-500"
                      : "text-slate-400"
                  }`}
        ...
        {/* Subtle footer text */}
        <p className="text-center text-xs to-slate-400 mt-6">

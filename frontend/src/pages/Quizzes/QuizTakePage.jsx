      ...
      <div className="flex items-center justify-center min-h-[60vh]">
        <div className="text-center">
          <p className="text-slate-600 text-lg">
            Quiz session was not found or has already been taken
          </p>
        </div>
      </div>
    );
  ...
  return (
    <div className="max-w-4xl mx-auto">
      ...
      <div className="mb-6">
        <div className="flex items-center justify-between mb-2">
          <span className="text-sm font-semibold text-slate-700">
            Question {currentNumber} of {quiz.questions.length}
          </span>
        ...
        <div className="relative h-2 bg-slate-100 rounded-full overflow-hidden">
          <div
            ...
            style={{
              width: `${(currentNumber / quiz.questions.length) * 100}%`,
            }}
          />
        </div>
      </div>
      ...
      <div className="flex items-center justify-between gap-4">
        ...
        >
          <ChevronLeft
            className="w-4 h-4 group-hover:translate-x-0.5 duration-200"
            strokeWidth={2.5}
          />
          Previous
        </Button>
      ...
      <div className="mt-3 overflow-x-auto h-full pb-3">
          ...
          {quiz.questions.map((_, index) => {
            ...
            return (
              <button
                ...
                disabled={submitting}
                className={`w-8 h-8 shrink-0 rounded-lg font-semibold text-xs cursor-pointer transition-all duration-200 ${
                  isCurrent

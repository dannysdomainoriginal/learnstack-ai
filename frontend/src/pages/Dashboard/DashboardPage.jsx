...
const DashboardPage = () => {
  ...
  if (!dashboardData || !dashboardData.overview) {
    return (
      <div className="min-h-full -m-6 bg-linear-to-r from-slate-50 via-white to-slate-50 flex items-center justify-center">
          ...
          {stats.map((stat, index) => (
            ...
            >
              <div className="flex items-center justify-between">
                ...
                <div
                  className={`w-11 h-11 rounded-xl bg-linear-to-br ${stat.gradient} shadow-lg ${stat.shadowColor} flex items-center justify-center group-hover:scale-110 transition-transform duration-200`}
                >
              ...
              {[
                ...(dashboardData.recentActivity.documents || []).map(
                  (doc) => ({
                    ...
                    timestamp: doc.lastAccessed ?? doc.uploadDate,
